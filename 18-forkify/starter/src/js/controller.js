...
const showRecipe = async function () {
  try {
          ...
          <div class="recipe__ingredients">
            ...
            <ul class="recipe__ingredient-list">
              ${recipe.ingredients
                ...
                // .join('') turns it into a big string containing all ingredients
                .join('')} 
          </div>
    ...
    `;
    recipeContainer.innerHTML = ''; // removing msg from bottom
    recipeContainer.insertAdjacentHTML('afterbegin', markup); // displaying container
  } catch (err) {
    alert(err);
  }
};
